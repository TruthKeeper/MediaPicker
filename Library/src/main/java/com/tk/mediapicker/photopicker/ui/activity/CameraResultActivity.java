...
public class CameraResultActivity extends AppCompatActivity {
    ...
    private void startCamera() {
        ...
        if (cameraIntent.resolveActivity(getPackageManager()) != null) {
            ...
            try {
                tempCameraFile = CameraUtils.createTmpFile(this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Constants.CAMERA_REQUEST) {
            if (resultCode != Activity.RESULT_OK) {
                ...
                if (getIntent().getExtras().getBoolean(Constants.PhotoPickConstants.NEED_CROP)) {
                    //去裁剪
                    startCrop();
                } else {
                    //展示结果
            ...
            if (resultCode != Activity.RESULT_OK) {
                ...
                intent.putExtra(Constants.PhotoPickConstants.RESULT_DATA, tempCropFile.getAbsolutePath());
    ...
    private void initView() {
        ...
        confirmBtn.setOnClickListener(v -> {
            ...
            data.putExtra(Constants.PhotoPickConstants.RESULT_DATA, tempCameraFile.getAbsolutePath());
